...
import { ShoppingBag, Sparkles, Scale, CheckCircle2 } from "lucide-react";
import { Product, useCart } from "../context/CartContext";

// Les produits (inchangés)
...
function DropZone({ isOver }: { isOver: boolean }) {
  ...
  return (
    <div
      ref={setNodeRef}
      className={`relative h-[400px] w-full rounded-[2.5rem] border-4 border-dashed flex flex-col items-center justify-center transition-all duration-500
    ...
    >
      ...
      <div className="mt-6 text-center px-6">
        ...
        <p className="text-[#8b5e34] mt-2 text-sm italic">Glissez vos douceurs ici pour commander au Kg</p>
      </div>
    </div>
  );
}
