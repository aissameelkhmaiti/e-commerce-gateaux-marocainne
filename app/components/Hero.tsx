...
const SLIDES = [
  ...
  },
  {
    ...
    image:
      "https://i.ytimg.com/vi/BflnoEsgmx8/hq720.jpg?sqp=-oaymwEhCK4FEIIDSFryq4qpAxMIARUAAAAAGAElAADIQj0AgKJD&rs=AOn4CLBsANh0Ss5sGRrr0ID0ydie7Nv3fQ",
    color: "#c29b40",
  },
  {
    id: 3,
  ...
  },
  {
    id: 4,
    title: "Kaab El Ghzal",
    subtitle: "Une douceur raffinée inspirée du patrimoine marocain",
    image:
      "https://i.ytimg.com/vi/WVi0i4QjL0Q/hq720.jpg?sqp=-oaymwEhCK4FEIIDSFryq4qpAxMIARUAAAAAGAElAADIQj0AgKJD&rs=AOn4CLAEahvABgW0nbSU8n-147S-PTdIRQ",
    color: "#5d4037",
  },
];
    ...
    <section className="relative h-[85vh] w-full overflow-hidden bg-[#fdfaf5]">
          ...
          <div className="relative z-10 h-full max-w-7xl mx-auto px-6 lg:px-12 flex flex-col justify-center">
            ...
            >
              ...
              <div className="flex gap-4 pt-6">
                <Link
                  href="/creations"
                  className="bg-[#c29b40] hover:bg-[#201b0e] text-white px-[60px] py-4 rounded-sm flex items-center gap-3 transition-all duration-300 uppercase tracking-widest text-xs"
                >
                  Commander
                  <ArrowRight size={16} />
                </Link>
      ...
      <div className="absolute bottom-0 left-0 w-full z-20 flex">
        {SLIDES.map((_, index) => (
          <div
            key={index}
            className="h-1.5 flex-1 bg-white/10 overflow-hidden cursor-pointer"
