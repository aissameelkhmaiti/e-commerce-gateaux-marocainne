      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16 space-y-3">
          ...
          <p className="text-sm text-gray-600 font-light max-w-md mx-auto">
            Une question sur vos commandes, besoin d&apos;un
            devis sur-mesure pour un événement ? Notre équipe
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-7 bg-white p-8 lg:p-10 rounded-2xl border border-gray-100 shadow-sm">
            <h2 className="text-2xl font-serif text-[#1a120b] mb-6">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-emerald-700 font-light mt-1">
                    Merci pour votre intérêt. Notre équipe
                    prendra soin de vous répondre sous 24h.
                  </p>
                </div>
              </motion.div>
            ) : (
              ...
              >
                ...
                <div className="space-y-2">
                  ...
                  <select className="w-full px-4 py-3 bg-[#fdfaf5] border border-gray-200 rounded-lg text-sm text-[#1a120b] focus:outline-none focus:border-[#c29b40] transition-colors appearance-none cursor-pointer">
                    <option>
                      Question sur une commande en cours
                    </option>

                    <option>
                      Devis pour un événement / mariage
                    </option>

                    <option>
                      Partenariat ou commande pro
                    </option>
          ...
          <div className="lg:col-span-5 space-y-8">
            <div className="bg-[#1a120b] text-white p-8 rounded-2xl space-y-6 shadow-xl relative overflow-hidden">
              ...
              <h3 className="text-xl font-serif text-[#c29b40]">
                Atelier Allo Lhalawa
              </h3>

              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  <MapPin
                    className="text-[#c29b40] shrink-0 mt-1"
                    size={20}
                  />

                  <div>
                    <h5 className="text-xs uppercase tracking-wider text-gray-400 font-medium">
                      Adresse
                    </h5>

                    <p className="text-sm font-light mt-0.5">
                      12 Boulevard Ghandi, Quartier Maârif,
                      Casablanca, Maroc
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[#c29b40] font-light">
                      +212 6 61 00 00 00 (WhatsApp)
                    </p>
                  </div>
                </div>
